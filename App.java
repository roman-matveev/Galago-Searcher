...
public class App {
    ...
    private void handleCrawl(String[] args) throws Exception {
    	...
    	//Create URL object (passing Chmod link)
    	URL seedUrl = new URL(args[0]);

    	//Set folder for storing HTML files
    	crawler.setFolder(args[1]);

    	//Call method run in Crawler passing URL object
    	crawler.run(seedUrl);
    }
    ...
    private void handleTestTokenizer(String[] args) throws Exception {
        ...
        System.out.print("TagTokenizer result: \n");
        ...
        System.out.print("Tokenizer result: \n");
